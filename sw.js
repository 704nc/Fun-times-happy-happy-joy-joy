...
const CACHE = 'win11-web-v18';
const ASSETS = [
  './', './index.html', './css/win11.css',
  './js/kernel.js', './js/wm.js', './js/apps-core.js', './js/apps-office.js',
  './js/apps-social.js', './js/apps-store.js', './js/apps-fun.js', './js/apps-more.js', './js/apps-extra.js', './js/apps-plus.js', './js/apps-live.js', './js/apps-tools.js', './js/apps-ultra.js', './js/apps-mega.js', './js/apps-nova.js', './js/apps-zeta.js', './js/apps-omega.js', './js/apps-link.js', './js/apps-sigma.js', './js/apps-theta.js', './js/shell.js', './js/main.js',
